...
## Description
Project OTP generator: automation utility built with JavaScript/TypeScript, HTML/CSS. This folder contains the source code and resources needed to review, run, and adapt the solution as part of the portfolio.

## What It Does
- Provides a practical solution related to the project name: OTP generator.
...
2. Open the Projects/OTP generator folder.
