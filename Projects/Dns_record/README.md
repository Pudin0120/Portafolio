...
## Description
Project Dns_record: automation utility built with Python. This folder contains the source code and resources needed to review, run, and adapt the solution as part of the portfolio.

## What It Does
- Provides a practical solution related to the project name: Dns_record.
...
2. Open the Projects/Dns_record folder.
