...
## Description
Project Word Guess Game: interactive game or simulator built with Java. This folder contains the source code and resources needed to review, run, and adapt the solution as part of the portfolio.

## What It Does
- Provides a practical solution related to the project name: Word Guess Game.
...
2. Open the Projects/Word Guess Game folder.
3. Open the project in the matching editor or IDE, then compile or run the main file.

## Usage
- `javac "word_guess_game.java"`
- `java word_guess_game`

## Main Structure
- `README.md`
- `word_guess_game.java`
