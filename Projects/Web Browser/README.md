...
## Description
Project Web Browser: application built with Java, XML. This folder contains the source code and resources needed to review, run, and adapt the solution as part of the portfolio.

## What It Does
- Provides a practical solution related to the project name: Web Browser.
...
- `README.md`
- `src/OxygenBrowser.java`
- `src/OxygenBrowserMain.java`
