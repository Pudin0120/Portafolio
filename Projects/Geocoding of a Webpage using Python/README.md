# Geocoding of a Webpage using Python

## Description
Project Geocoding of a Webpage using Python: automation utility built with Python. This folder contains the source code and resources needed to review, run, and adapt the solution as part of the portfolio.

## What It Does
- Provides a practical solution related to the project name: Geocoding of a Webpage using Python.
...
2. Open the Projects/Geocoding of a Webpage using Python folder.
