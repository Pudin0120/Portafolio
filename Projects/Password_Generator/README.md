...
## Description
Project Password_Generator: automation utility built with Java. This folder contains the source code and resources needed to review, run, and adapt the solution as part of the portfolio.

## What It Does
- Provides a practical solution related to the project name: Password_Generator.
...
2. Open the Projects/Password_Generator folder.
3. Open the project in the matching editor or IDE, then compile or run the main file.

## Usage
- `javac "Password Generator/src/Alphabet.java"`
- `java Alphabet`
