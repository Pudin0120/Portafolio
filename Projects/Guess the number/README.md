...
## Description
Project Guess the number: interactive game or simulator built with Java, XML. This folder contains the source code and resources needed to review, run, and adapt the solution as part of the portfolio.

## What It Does
- Provides a practical solution related to the project name: Guess the number.
...
2. Open the Projects/Guess the number folder.
...
- `pom.xml`
- `README.md`
- `src/main/java/learningspace/swtest/examples/GameLogic.java`
- `src/main/java/learningspace/swtest/examples/GuessTheNumberGame.java`
- `src/test/java/learningspace/swtest/examples/GameLogicTest.java`
