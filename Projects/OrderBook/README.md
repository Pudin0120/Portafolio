...
## Description
Project OrderBook: application built with Java. This folder contains the source code and resources needed to review, run, and adapt the solution as part of the portfolio.

## What It Does
- Provides a practical solution related to the project name: OrderBook.
...
2. Open the Projects/OrderBook folder.
3. Open the project in the matching editor or IDE, then compile or run the main file.

## Usage
- `javac "src/main/orderbook/Helpers.java"`
- `java Helpers`

## Main Structure
- `README.md`
- `src/main/orderbook/Helpers.java`
- `src/main/orderbook/OrderBook.java`
- `src/main/orderbook/OrderBookApp.java`
