...
## Description
Project Department-Wise Salary Calculation: application built with Java, XML. This folder contains the source code and resources needed to review, run, and adapt the solution as part of the portfolio.

## What It Does
- Provides a practical solution related to the project name: Department-Wise Salary Calculation.
...
2. Open the Projects/Department-Wise Salary Calculation folder.
...
- `pom.xml`
- `README.md`
- `src/main/java/assessment/Department_salary.java`
- `src/main/java/assessment/salary.java`
