...
public class Main{
	...
	public static void main(String[] args) {
        ...
        avl.create ("v","BlackAmerican slang for an unfriendly female");
        ...
        avl.create ("vacuum cleaner","BlackAmerican slang for ones lungs");
...
V -BlackAmerican slang for an unfriendly female
...
VACUUM CLEANER -BlackAmerican slang for ones lungs
WAA -Crying
