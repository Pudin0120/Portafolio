...
<html>
	...
	<table border="1">
		...
		<tr>
			...
			<td><a href="${root}/tbTaskDetailAction!delete.action?tbTaskDetail.taskDetailId=${tbTaskDetail.taskDetailId}"></a></td>
			<td><a href="${root}/tbTaskDetailAction!initUpdate.action?tbTaskDetail.taskDetailId=${tbTaskDetail.taskDetailId}"></a></td>
		</tr>
		</c:forEach>
	</table>
	</c:if>
