...
<html>
	...
	<table border="1">
		...
		<tr>
			...
			<td><a href="${root}/tbUserAction!delete.action?tbUser.userId=${tbUser.userId}"></a></td>
			<td><a href="${root}/tbUserAction!initUpdate.action?tbUser.userId=${tbUser.userId}"></a></td>
		</tr>
		</c:forEach>
	</table>
	</c:if>
