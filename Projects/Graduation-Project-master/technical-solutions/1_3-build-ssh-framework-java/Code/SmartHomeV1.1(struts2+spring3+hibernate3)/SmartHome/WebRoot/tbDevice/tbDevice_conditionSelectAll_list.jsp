...
<html>
	...
	<table border="1">
		...
		<tr>
			...
			<td><a href="${root}/tbDeviceAction!delete.action?tbDevice.deviceId=${tbDevice.deviceId}"></a></td>
			<td><a href="${root}/tbDeviceAction!initUpdate.action?tbDevice.deviceId=${tbDevice.deviceId}"></a></td>
		</tr>
		</c:forEach>
	</table>
	</c:if>
