...
<html>
	...
	<table border="1">
		...
		<tr>
			...
			<td><a href="${root}/tbMessageAction!delete.action?tbMessage.messageId=${tbMessage.messageId}"></a></td>
			<td><a href="${root}/tbMessageAction!initUpdate.action?tbMessage.messageId=${tbMessage.messageId}"></a></td>
		</tr>
		</c:forEach>
	</table>
	</c:if>
