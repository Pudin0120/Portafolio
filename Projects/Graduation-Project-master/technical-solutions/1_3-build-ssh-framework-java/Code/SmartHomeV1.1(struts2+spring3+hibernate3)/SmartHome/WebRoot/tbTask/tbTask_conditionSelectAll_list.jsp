...
<html>
	...
	<table border="1">
		...
		<tr>
			...
			<td><a href="${root}/tbTaskAction!delete.action?tbTask.taskId=${tbTask.taskId}"></a></td>
			<td><a href="${root}/tbTaskAction!initUpdate.action?tbTask.taskId=${tbTask.taskId}"></a></td>
		</tr>
		</c:forEach>
	</table>
	</c:if>
