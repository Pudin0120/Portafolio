...
## Description
Project Email_Generator: application built with Java. This folder contains the source code and resources needed to review, run, and adapt the solution as part of the portfolio.

## What It Does
- Provides a practical solution related to the project name: Email_Generator.
...
2. Open the Projects/Email_Generator folder.
3. Open the project in the matching editor or IDE, then compile or run the main file.

## Usage
- `javac "src/emailgenerator/EmailBackProgram.java"`
- `java EmailBackProgram`

## Main Structure
- `.DS_Store`
- `README.md`
- `src/emailgenerator/EmailBackProgram.java`
- `src/emailgenerator/EmailMainProgram.java`
