...
## Description
Project Correct Number Guess Game: interactive game or simulator built with Java. This folder contains the source code and resources needed to review, run, and adapt the solution as part of the portfolio.

## What It Does
- Provides a practical solution related to the project name: Correct Number Guess Game.
...
2. Open the Projects/Correct Number Guess Game folder.
