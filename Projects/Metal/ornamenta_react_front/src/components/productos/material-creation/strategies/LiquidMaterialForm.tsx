...
/**
 * Componente de formulario para la estrategia LIQUID (Liquidos)
 */
...
/**
 * LIQUID Strategy Form - Built with Builder Pattern approach
 */
export const LiquidMaterialForm: React.FC<StrategyFormComponentProps> = ({
  dynamicProperties,
  onPropertyChange,
  strategyConfig,
  shouldShowProperty,
          ...
          <div className="space-y-4">
            {materialTypeObj?.requires_composition !== false && (
              <div className="space-y-1">
                <Autocomplete
                  label="Composicion"
                  placeholder="Ej: Pintura, Solvente..."
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <PropertyLabel
                  displayName="Volumen"
                  isRequired
                  description="Capacidad neta del envase"
                />
                <MeasurementField
                  propName="volume"
                  propUnit={dynamicProperties[`volume_unit`] || "L"}
                  prop={
                    {
