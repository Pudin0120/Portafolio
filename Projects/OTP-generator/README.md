...
## Description
Project OTP-generator: automation utility built with Java. This folder contains the source code and resources needed to review, run, and adapt the solution as part of the portfolio.
