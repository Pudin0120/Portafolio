...
#define		FiRx_FB 	   ((u32)0xFFFFFFFFF)	  //Filter bits    -- identifier -0: Dominant bit is expected / 1: Recessive bit is expected / Mask - 0: Do not care, the bit is not used for the comparison 1: Must match,
