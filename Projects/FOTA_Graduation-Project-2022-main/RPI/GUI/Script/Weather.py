...
class MainAPP_Weather(QWidget, FormClass):
    ...
    def accessAPI(self):
        ...
        if maxTemp < currentTemp:
            maxTemp = str(currentTemp) + ' deg'
        else:
            maxTemp = str(maxTemp) + ' deg'
        ...
        if minTemp > currentTemp:
            minTemp = str(currentTemp) + ' deg'
        else:
            minTemp = str(minTemp) + ' deg'
